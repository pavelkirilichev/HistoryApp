        ...
        <View style={styles.styles2.view}>
            ...
            <View style={styles.styles2.btnCont}>
                <TouchableOpacity
                    ...
                    onPress={() =>
                        navigation.navigate('WH_Process')
                    }
                    >
                    <Text style={styles.styles2.buttonText}>Процессы</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[
                    ...
                    onPress={() =>
                        navigation.navigate('WH_Countries')
                    }
                    >
                    <Text style={styles.styles2.buttonText}>Страны</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[
