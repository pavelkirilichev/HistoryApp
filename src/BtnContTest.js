...
function BtnContTest({ answer, navigation, setstate, route, question, level }) {
    const [color_1, setcolor_1] = useState("#bdf1f5");
    const [color_2, setcolor_2] = useState("#bdf1f5");
    const [color_3, setcolor_3] = useState("#bdf1f5");
    const [color_4, setcolor_4] = useState("#bdf1f5");
    ...
    return (
        <View style={t_styles.btnCont}>
            <TouchableOpacity
                style={[
                    t_styles.button(c_razm), {backgroundColor: color_1}
                ]}
                onPress={ () => 
                    ChoiseAnswer(answer, "А", question) 
                }
                >
            ...
            <TouchableOpacity
                style={[
                    t_styles.button(c_razm), {backgroundColor: color_2}
                ]}
                onPress={() =>
                    ChoiseAnswer(answer, "Б", question)
                }
                >
            ...
            <TouchableOpacity
                style={[
                    t_styles.button(c_razm), {backgroundColor: color_3}
                ]}
                onPress={() =>
                    ChoiseAnswer(answer, "В", question)
                }
                >
            ...
            <TouchableOpacity
                style={[
                    t_styles.button(c_razm), {backgroundColor: color_4}
                ]}
                onPress={() =>
                    ChoiseAnswer(answer, "Г", question)
                }
                >
