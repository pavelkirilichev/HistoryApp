...
function TestLvl1 ({ navigation, route }) {
    ...
    let TestObj = tests.filter(test => test.name === testName).filter(test => test.level === 1)
    ...
    return (
        <View style={styles.styles_all.view}>
            ...
            <ScrollView contentContainerStyle={t_styles.main}>
                ...
                <BtnContTest answer={answer_accept} navigation={navigation} setstate={setstate_ren} route={testNameEng} question={qestion} level={1}/>
            </ScrollView>
