    ...
    <View style={styles.styles2.view}>
      ...
      <View style={styles.styles2.btnCont}>
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate("Per_TestLvl1", { name: "Century20" })
          }
        >
        ...
        <TouchableOpacity
          style={[styles.styles2.button]}
          onPress={() =>
            navigation.navigate("Per_TestLvl2", { name: "Century20" })
          }
        >
        ...
        <TouchableOpacity
          style={[styles.styles2.button]}
          onPress={() =>
            navigation.navigate("Per_TestLvl3", { name: "Century20" })
          }
        >
