        ...
        <View style={styles.styles_all.view}>
            ...
            <View style={styles.styles2.btnCont}>
                <TouchableOpacity
                    ...
                    onPress={() =>
                        navigation.navigate('Per_TestLvl1', {name: 'Rus19'})
                    }
                    >
                ...
                <TouchableOpacity
                    ...
                    onPress={() =>
                        navigation.navigate('Per_TestLvl2', {name: 'Rus19'})
                    }
                    >
                ...
                <TouchableOpacity
                    ...
                    onPress={() =>
                        navigation.navigate('Per_TestLvl3', {name: 'Rus19'})
                    }
                    >
