...
function TestLvl2 ({ navigation, route }) {
    ...
    let TestObj = arrayRandElement(tests.filter(test => test.name === testName).filter(test => test.level === 2), question)
        ...
        <View style={styles.styles_all.view}>
            ...
            <ScrollView contentContainerStyle={t_styles.main}>
                <View style={t_styles.textDiv}>
                    ...
                    <Text style={t_styles.text}><Text style={t_styles.bold}>А)</Text> {answers_arr[0]}</Text>
                    <Text style={t_styles.text}><Text style={t_styles.bold}>Б)</Text> {answers_arr[1]}</Text>
                    <Text style={t_styles.text}><Text style={t_styles.bold}>В)</Text> {answers_arr[2]}</Text>
                    <Text style={t_styles.text}><Text style={t_styles.bold}>Г)</Text> {answers_arr[3]}</Text>
                </View>
                <BtnContTest answer={answer_accept} navigation={navigation} setstate={setstate_ren} route={testNameEng} question={qestion} level={2} />
            </ScrollView>
